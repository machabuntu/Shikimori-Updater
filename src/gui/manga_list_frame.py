...
class MangaListFrame(ttk.Frame):
    ...
    def _create_context_menu(self):
        ...
        self.context_menu.add_command(label="Edit", command=self._edit_manga)
        self.context_menu.add_separator()
        ...
        self.context_menu.add_command(label="Mark as Reading", command=lambda: self._change_status("watching"))
